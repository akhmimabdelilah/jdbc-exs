...
public class CreateDB {
  ...
  public static void main(String[] args) throws Exception {
    try {
      ...
      //   // "START TRANSACTION;" +
      //   // "SET time_zone = \"+00:00\";" +
      //   "USE CREATE TABLE `client` (`id` int(11) NOT NULL, `nom` varchar(50) NOT NULL, `prenom` varchar(50) NOT NULL, `date` date NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;" +
